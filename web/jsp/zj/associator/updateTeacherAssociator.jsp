...
<body>
       ...
       function submitAssociator(){
    	   var r = $('#associatorUpTeacher').form('validate');
	   ...
	   $.post("${ctx}/associator/updateTeacher",$("#associatorUpTeacher").serializeArray(),function(data){
      	  $.messager.alert('提示',data.mes,'info',function(){
      		 $('#teacher_box').dialog('destroy');
       ...
       <form id="associatorUpTeacher" method="post" style="margin:0;text-align: center;">
              ...
              <table style="width:100%; font-size:12px; border:0px solid #f0f0f0;" cellpadding="0" cellspacing="0" class="bordertable">
                     ...
                     <tr>
                        ...
                        <td width="35%" align="left">
				            <input name="teacherNo" id="teacherNo" style="width:175px;height:20px;" class="easyui-validatebox textbox" required="true"  validType="length[1,64]">
				        </td>
				        <td width="15%" align="right">所教课程：</td>
                        <td width="35%" align="left">
                             <input type="text" name="courses" id="courses" style="width:100px;height:20px;"  class="easyui-validatebox textbox"  required="true" validType="chkAccount[1,128]">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="35%" align="left">
				            <input name="phone" id="phone" style="width:175px;height:20px;"  class="easyui-numberbox  h25" required="true"  validType="length[1,64]">
				        </td>
				        <td width="15%" align="right">qq号：</td>
                        <td width="35%" align="left">
				            <input name="qq" id="qq" style="width:175px;height:20px;"  class="easyui-numberbox  h25" required="true"  validType="length[1,64]">
				        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="35%" align="left">
				            <input name="mail" id="mail" style="width:175px;height:20px;"  class="easyui-validatebox textbox" required="true"  validType="length[1,64]">
				        </td>
                    ...
                    <tr>
				        <td colspan="4" align="center">
					       <a href="#" id="btn-back" onclick="closeDialog('teacher_box');" class="easyui-linkbutton" iconCls="icon-back">返回</a>
