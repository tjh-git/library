...
<body>
      <script type="text/javascript">
               ...
               function submitAssociator(){
            	   var r = $('#associatorStudent').form('validate');
            	   ...
            	   $.post("${ctx}/associator/addStudent",$("#associatorStudent").serializeArray(),function(data){
      ...
      <form id="associatorStudent" method="post" style="margin:0;text-align: center;">
