...
<body>
       ...
       function submitAssociator(){
    	   var r = $('#associatorTeacher').form('validate');
	   ...
	   $.post("${ctx}/associator/addTeacher",$("#associatorTeacher").serializeArray(),function(data){
       ...
       <form id="associatorTeacher" method="post" style="margin:0;text-align: center;">
