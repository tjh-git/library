...
<body>
      <script type="text/javascript">
                ...
                function submitAssociator(){
                	var r = $('#addBookList').form('validate');
                    ...
                    $.post("${ctx}/bookInfo/addBookTwo",$("#addBookList").serializeArray(),function(data){
      ...
      <form id="addBookList" method="post" style="margin:0;text-align: center;">
