...
<div id="wrap">
	<div id="position">您的当前位置：<a href="${ctx}/website/index">首页</a> >> 站内搜索  </div>
	<div id="main">
	<div class="main_left">
		<div class="cylm">
			...
			<ul class="more_news">
				...
				<li style="background:none;text-align:center;">
					<div style="text-align:center;">
						<a href="${ctx}/website/znss?key=${key}&currentPage=1">首页</a>&nbsp;&nbsp;
						<c:choose>
							<c:when test="${pageBean.currentPage==1}">
							<a href="${ctx}/website/znss?key=${key}&currentPage=1">上一页</a>&nbsp;&nbsp;					
							</c:when>
							<c:otherwise>
							<a href="${ctx}/website/znss?key=${key}&currentPage=${pageBean.currentPage-1}">上一页</a>&nbsp;&nbsp;
							</c:otherwise>
						</c:choose>						
						<a id="num" href="${ctx}/website/znss?key=${key }&currentPage=${pageBean.currentPage+1}">下一页</a>&nbsp;&nbsp;
						<a href="${ctx}/website/znss?key=${key }&currentPage=${pageBean.totalPages}">尾页</a>
					</div>				
				</li>				
			</ul>
