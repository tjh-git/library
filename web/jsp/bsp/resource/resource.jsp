	...
	jQuery(function($){
		...
		$('#resourceTable').datagrid({
			...
			toolbar:[
					...
					{text:'资源注册', iconCls:'icon-reg',
						handler:function(){regResRow();}
					},'-',
					{text:'查看资源树', iconCls:'icon-view',
...
<form id="resourceQuForm" style="margin:0; text-align:center; font-size:12px">
	...
	<table style="width:98%; font-size:12px; border:0px solid #f0f0f0;">
		<tr>
			<td width="70" align="right">资源名称：</td>
			<td width="180" align="left"><input name="resourceName" style="width:250"></td>
			<td width="70" align="left">资源URL：</td>
			<td width="180" align="left"><input name="resourceString" style="width:250"></td>
			<td align="left">
