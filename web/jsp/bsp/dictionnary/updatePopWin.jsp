...
<html>
	...
	function updateSysParam(){
		...
		var r = $('#dictionnaryUpForm').form('validate');
		if(!r) {
			return false;
		}
		
		//更新
		$.post("dictionnary/updateDictionnary", $("#dictionnaryUpForm").serializeArray(),function(data){
	...
	<form id="dictionnaryUpForm" method="post" style="margin:0;text-align: center;">
		<!-- 隐藏域 -->
