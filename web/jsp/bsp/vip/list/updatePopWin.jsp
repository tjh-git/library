...
<script type="text/javascript">
    ...
    function updateTeacher() {
        ...
        //更新
        $.post("list/updateVIP", $("#vipUpForm").serializeArray(), function (data) {
...
<form id="vipUpForm" method="post" style="margin:0;text-align:center;">
    <table style="width:100%; font-size:12px;" cellpadding="0" cellspacing="0" class="bordertable">
        <tr style="display: none;">
            <td width="15%" align="right">索引：</td>
        ...
        <tr>
            ...
            <td width="30%" align="left">
                <input name="readCard" style="width:150px;height:20px;" class="easyui-validatebox textbox" required="true" validType="length[1,16]">
            </td>
        ...
        <tr>
            ...
            <td width="30%" align="left">
                <input id="ID" name="ID" type="text" name="orgName" validType="chkPwd[18,18]" style="width:150px">
            </td>
        ...
        <tr>
            ...
            <td width="30%" align="left">
                <input name="cardType" class="easyui-textbox" style="width:150px;height:20px;" maxlength="16">
            </td>
        ...
        <tr>
            ...
            <td width="30%" align="left">
                <input name="stuID" style="height:20px;width:150px;" class="easyui-textbox"  />
            </td>
