...
<script type="text/javascript">
    function edit() {
        setTimeout(function () {
            ...
            window.location.href = "/statistics/schools/update?school_id=" + ids;
        }, 20)
    }
            jQuery(function($) {
                ...
                jQuery(grid_selector).jqGrid({
                    ...
                    //direction: "rtl",
                    id:'school_id',
                    url:'/statistics/schools/getSchools',
                    //subgrid options
                    subGrid : true,
                 ...
                 //   datatype: "local",
                    height: 250,
                    colNames:[' ','学校编号', '学校名称','学校地址','联系人','学校邮编','学校电话','学校注册码','读者荐购平台','查看详情'],
                    colModel:[
                        {name:'edit',index:'myac', width:80, fixed:true, sortable:false, resize:false},
                        {name:'school_id',index:'school_id', width:150, sorttype:"int", editable: false,key:true},
                        {name:'school_name',index:'school_name', width:200, sorttype:"int", editable: true,},
                        {name:'school_position',index:'school_position', width:390, sorttype:"int", editable: true,},
                        {name:'school_contact',index:'school_contact', width:90, sorttype:"int", editable: true,},
                        {name:'school_post',index:'school_post', width:190, sorttype:"int", editable: true,},
                        {name:'school_tel',index:'school_tel', width:160, sorttype:"int", editable: true},
                        {name:'school_pass',index:'school_pass',width:170, editable: true},
                        {name:'school_href',index:'school_href',width:220, editable:true, sorttype:"int"},
                    ...
                    editurl: "/statistics/schools/editSchools",//nothing is saved
                    caption: "已注册学校列表"
...
<script>
    $("#list-6").addClass("active open")
    $("#list-6-4").addClass("active")
</script>
