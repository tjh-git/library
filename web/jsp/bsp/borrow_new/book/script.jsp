...
<script type="text/javascript">
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            //   datatype: "local",
            height: 250,
            colNames:['图书编号','图书名称', '借阅次数','借阅时间','借阅卡号','会员姓名','罚款金额','借阅状态','借阅人余额','归还时间','查看记录'],
            colModel:[
                {name:'book_id',index:'book_id', width:150, sorttype:"int", editable: false,key:true},
                {name:'bookname',index:'bookname', width:440, sorttype:"int", editable: false,},
                {name:'count',index:'count', width:150, sorttype:"int", editable: false,},
                {name:'borrowTime',index:'borrowTime', width:200, sorttype:"int", editable: false,},
                {name:'borrowerCode',index:'borrowerCode', width:190, sorttype:"int", editable: false,},
                {name:'borrowerName',index:'borrowerName', width:140, sorttype:"int", editable: false,},
                {name:'fine',index:'fine', width:160, sorttype:"int", editable: false},
                {name:'isOut',index:'isOut',width:170, editable: false},
                {name:'money',index:'money',width:170, editable:false, sorttype:"int"},
                {name:'returnTime',index:'returnTime', width:200, sorttype:"int", editable: false,},
...
<script>
    $("#list-4").addClass("active open")
    $("#list-4-3").addClass("active")
</script>
