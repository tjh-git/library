        ...
        success:function (data) {
            ...
            jQuery(function($) {
                ...
                jQuery(grid_selector).jqGrid({
                  ...
                  /*  subGridRowExpanded: function (subgridDivId, rowId) {
                    ...
                    subGridRowExpanded: function(subgrid_id, row_id) {  //(2)子表格容器的id和需要展开子表格的行id，将传入此事件函数
                        ...
                        $("#" + subgrid_table_id).jqGrid({
                            url: "/borrow/vip/bookShow?row_id="+row_id,  //(7)子表格数据对应的url，注意传入的contact.id参数
                            datatype: "json",
                            colNames: ['预存金额','应还时间'],
                            colModel: [
                                {name:'money',index:'money', width:100},
                                {name:'needReturn',index:'needReturn', width:100},
                            ],
                 ...
                 //   datatype: "local",
                    height: 250,
                    colNames:['索引','借阅证卡号','会员姓名','书籍编号','书籍名称', '会员卡类型', '借阅时间','归还时间','罚款金额','书籍状态','查看记录'],
                    colModel:[
                        {name:'id',index:'id',hidden:true},
                        {name:'borrowerCode',index:'borrowerCode', width:70, sorttype:"int", editable: true},
                        {name:'name',index:'name', width:50, sorttype:"int", editable: true},
                        {name:'bookCode',index:'bookCode',width:70, editable: true},
                        {name:'bookName',index:'bookName',width:160, editable: true},
                        {name:'cardType',index:'cardType',width:70, editable:true, sorttype:"int"},
                        {name:'borrowTime',index:'borrowTime', width:60, sorttype:"int", editable: true},
                        {name:'returnTime',index:'returnTime', width:60, sorttype:"int", editable: true},
                        {name:'fine',index:'fine', width:50, sorttype:"int", editable: true},
                        {name:'status',index:'status', width:40, sorttype:"int", editable: true},
