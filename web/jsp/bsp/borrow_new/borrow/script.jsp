...
<script type="text/javascript">
    $("#readCard").focusout(function () {
       $.ajax({
           type:'get',
           url:'/borrow/borrow/borrowBook',
           data:{readCard:$("#readCard").val()},
    ...
    $("#borrow").click(function(){
        $.ajax({
            url:"/borrow/borrow/borrowOneBook",
