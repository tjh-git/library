...
<script type="text/javascript">
    ...
    $("#submit").click(function(){
        ...
        if(type.length==0) {
            $.ajax({
                type: 'post',
                url: '/vip/teacher/addTeacher',
                data: $('#addTeacher').serializeArray(),
        ...
        }else
        {
            $.ajax({
                type:'post',
                url:'/vip/teacher/updateTeacher',
                data:$('#addTeacher').serializeArray(),
                success:function(data){
                    alert(data.mes);
                    $("#reset").trigger("click")
                    window.location.href="/jsp/bsp/vip_new/teacherList/blank.jsp";
                }
            })
        }
    })
