                ...
                jQuery(grid_selector).jqGrid({
                    ...
                    subGridRowExpanded: function(subgrid_id, row_id) {  //(2)子表格容器的id和需要展开子表格的行id，将传入此事件函数
                        ...
                        $("#" + subgrid_table_id).jqGrid({
                            ...
                            colNames: ['余额','班级','年级'],
                            colModel: [
                                {name:'money',index:'money', width:160, },
                                {name:'clazz',index:'clazz', width:160, },
                 ...
                 //   datatype: "local",
                    height: 250,
                    colNames:['操作', '索引','借阅卡号','姓名','身份证号', '性别', '会员卡类型','加入时间','会员卡状态','学号','借阅证有效期','查看记录'],
                    colModel:[
                        {name:'edit',index:'edit', width:80, fixed:true, sortable:false, resize:false},
                        {name:'id',inde:'id',hidden:true},
                        {name:'readCard',index:'readCard', width:80, sorttype:"int", editable: true},
                        {name:'name',index:'name', width:60, sorttype:"int", editable: true},
                        {name:'IDCard',index:'IDCard', width:110, sorttype:"int", editable: true},
                        {name:'gender',index:'gender',width:40, editable: true,edittype:"select",editoptions:{value:"男:男;女:女"}},
                        ...
                        {name:'stuID',index:'stuID', width:80, sorttype:"int", editable: true},
                    ...
                    onClickButton: function () {
                        ...
                        $.ajax({
                            ...
                            success:function(data){
                                ...
                                var str ="\ufeff";
                                str+=("借阅证卡号,姓名,身份证号,用户性别,会员卡类型,加入时间,会员状态,学号,班级,年级,借阅证有效期,账户余额"+n);
                                data=data.rows;
                                var rows=data;
