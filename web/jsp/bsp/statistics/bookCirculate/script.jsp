        ...
        success:function (data) {
            ...
            jQuery(function($) {
                ...
                jQuery(grid_selector).jqGrid({
                 ...
                 //   datatype: "local",
                    height: 250,
                    colNames:['索引', '借阅证卡号','会员姓名','书籍编号','书籍名称', '时间','操作','查看记录'],
                    colModel:[
                        {name:'id',index:'id', width:80, sorttype:"int", editable: true,keys:true,hidden:true},
                        {name:'user',index:'user_readCard', width:80, sorttype:"int", editable: true,},
                        {name:'user_name',index:'user_name', width:80, sorttype:"int", editable: true},
                        {name:'book',index:'book_code',width:80, editable: true},
                        {name:'book_name',index:'book_name',width:210, editable: true},
                        {name:'time',index:'time', width:80, sorttype:"int", editable: true},
                        {name:'action',index:'action',width:50, editable:true, sorttype:"int"},
                    ...
                    onClickButton: function () {
                        $.ajax({
                            ...
                            success:function(data){
                                ...
                                var str ="\ufeff";
                                str+=("索引,会员卡号,会员姓名,书籍编号,书籍名称,时间,操作"+n);
                                data=data.rows;
                                var rows=data;
