...
$(function() {
	...
	//		}
			...
			$.post("news/updateNews",$("#newsUpdateForm").serializeArray(),function(data){
...
<form id="newsUpdateForm"  method="post" style="">
	...
	<table class="table2" width="95%" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td width="25%" align="right">链接标题：</td>
				...
				<td  align="left" >
					<input type="radio" name="newsIsLinkTitle"  value="0"	 onchange="newsLik()" />否
					<input type="radio" name="newsIsLinkTitle"  value="1" checked="checked" onchange="newsLik()" />是	
				</td>
				<td colspan="2">
		...
		<tr>
			<td  align="center" colspan="4">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" id="btn-add" onclick="updateNews();" class="easyui-linkbutton" iconCls="icon-save">保存</a>
			</td>
		</tr>
		<tr>
			<td align="center" colspan="4">
