...
<body>
	...
	var editor = CKEDITOR.replace('newsContent2',{
			filebrowserUploadUrl : '${ctx}/news/upload?Type=hlink',  //超链接
...
$(function() {
	...
	$("#newsAccessory").css('display','none');
		...
		//	}
			...
			var newsType=$("#newsType1").val();
			if(newsType.length==0||newsType==""){
				alert("新闻类型不能为空");
				return ;
			}
			...
			$.post("news/saveNews",$("#newsAddForm").serializeArray(),function(data){
...
<form id="newsAddForm"  method="post" style="">
	<table class="table2" width="95%" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td width="25%" align="left">信息类型：
				<select id="newsType1" name="newsType" style="width: 50%;height: 30px" >
					<option value="" ></option>
		...
		<tr>
			<td  align="center" colspan="4">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" id="btn-add" onclick="saveNews();" class="easyui-linkbutton" iconCls="icon-save">保存</a>
			</td>
		</tr>
		<%-- 
		<tr>
			...
			<td align="left" >
			<input type="text" id="newsCompany"   name="newsCompany" style="height: 25px;width: 300px;" />
			</td>
		...
		<tr>
			...
			<input type="hidden" id="newsContent"   name="newsContent" />
			 ...
			 <%-- 
				<p>&nbsp;</p>
				<p>&nbsp;</p>
				<p style="text-align: right;"><span style="font-size:14px">人文社科研究院&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> </p>
