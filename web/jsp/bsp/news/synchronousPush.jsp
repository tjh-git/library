...
<html>
		...
		$.ajax({
			...
			success:function(data){
				...
				$.each(data, function(n, val) {
					allAuths.append('<option value="' + val.newsTypeCode + '">' + val.newsTypeName + '</option>');
            	});
			}
		});
	});
	...
	function upRoleAuth(){
        ...
        var newsId = '<%=request.getAttribute("newsId") %>';
        
		//更新
		$.post("news/synchronousPush?newsIds="+chooseOpts+"&newsId="+newsId, $("#synchronousPushForm").serializeArray(),function(data){
	...
	<form id="synchronousPushForm" method="post" style="margin:0;text-align: center;">
		
    	<div class="content">
    		<div class="top">
    			请将需要同步推送的信息类型移到右侧选择框
    		</div>
    		<div class="select">
