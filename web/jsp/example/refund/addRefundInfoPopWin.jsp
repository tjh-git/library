...
<html>
	...
	function submitRefundInfo(){
		var r = $('#refundInfoAddForm').form('validate');
		if(!r) {
			return false;
		}
		if($("#type").combotree('getValue')==''){  //combotree=?
			$.messager.alert('提示','请选择退费类型','info');
			return;
		}
	
		$.post("${ctx}/finance/addRefundInfo",$("#refundInfoAddForm").serializeArray(),function(data){
	...
	<form id="refundInfoAddForm" method="post" style="margin:0;text-align: center;">
		<table style="width:100%; font-size:12px; border:0px solid #f0f0f0;" cellpadding="0" cellspacing="0" class="bordertable">
			...
			<tr>
				<td colspan="4" align="center">
					...
					<a href="#" id="btn-add" onclick="submitRefundInfo();" class="easyui-linkbutton" iconCls="icon-save">保存</a>
				</td>
			</tr>																								
		</table>
	</form>
